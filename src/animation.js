...
document.getElementById('startButton').addEventListener('click', () => {
    stopAnimation();
    focusOnSouthAmerica();
    document.getElementById('startButton').style.display = 'none'; // Esconder o botão "Start"
    document.getElementById('brazilButton').classList.remove('hidden'); // Mostrar o botão "Brazil"
});
